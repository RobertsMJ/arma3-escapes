...
_fnc_CreateRoadBlock = {
   ...
   // private _static = [_gun, (_pos vectoradd [10,0,0]), _dir, _centerPos, _rotateDir] call _fnc_CreateObject;
    ...
    _unit1 = _group createUnit [selectRandom _guardTypes, _pos, [], 0, "FORM"];
	[_unit1] joinSilent _group;
    _unit2 = _group createUnit [selectRandom _guardTypes, _pos, [], 0, "FORM"];
	[_unit2] joinSilent _group;
    _unit3 = _group createUnit [selectRandom _guardTypes, _pos, [], 0, "FORM"];
	[_unit3] joinSilent _group;
