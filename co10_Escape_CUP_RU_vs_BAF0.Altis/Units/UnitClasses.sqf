...
a3e_arr_Escape_InfantryTypes_AT = ["CUP_B_BAF_Soldier_AT_WDL","CUP_B_BAF_Soldier_HAT_WDL"];
a3e_arr_Escape_InfantryTypes_AA = ["CUP_B_BAF_Soldier_AA_WDL"];
a3e_arr_Escape_InfantryTypes_Ind = [
	...
	,"CUP_I_PMC_Contractor1"
	,"CUP_I_PMC_Contractor2"];
a3e_arr_Escape_InfantryTypes_AT_Ind = ["CUP_I_PMC_Soldier_AT"];
a3e_arr_Escape_InfantryTypes_AA_Ind = ["CUP_I_PMC_Soldier_AA"];
